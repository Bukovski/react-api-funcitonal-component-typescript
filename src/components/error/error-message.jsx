  ...
  return (
    <div className="error-indicator">
      <svg className="error-image" viewBox="0 0 490 525">
        ...
        <path fill="none" stroke="#6A1B9A" strokeWidth="24" strokeLinecap="round" strokeMiterlimit="10" d="M431 232c3 15 21 19 34 11 15-9 14-30 5-43-12-17-38-25-59-10-23 18-27 53-21 97s1 92-63 108" />
      ...
      <div className="error-text-wrap">
        <h4 className="error-header-text">Wooops</h4>
        <p className="error-text">something has gone terribly wrong</p>
        <p className="error-text">we will fix it. May be</p>
      </div>
    </div>
  )
}
